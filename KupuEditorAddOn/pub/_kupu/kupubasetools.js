...
// $Id: kupubasetools.js,v 1.1 2004/10/10 19:13:12 romano Exp $
 ...
 * - 2004-10-04 - In KupuTool() and KupuToolBox(), new function completeState().
 * - 2004-10-04 - In LinkTool(), put in comment createContextMenuElements()
 *  
 *****************************************************************************/
...
function KupuTool() {
    ...
    */
    ...
    this.completeState = function(selNode, event) {
        /* TWiki KupuEditorAddOn : catch KeyUp event */ 
        for (id in this.toolboxes) {
            this.toolboxes[id].completeState(selNode, event);
        };
    };
...
function LinkTool() {
    ...
    /* TWiki KupuEditorAddOn : remove context menu */
    //this.createContextMenuElements = function(selNode, event) {
