# Install script for TRefactorAddOn
#
...
sub satisfy {
	 ...
	 unless ( $ok ) {
		  print "*** TRefactorAddOn depends on package $dep->{name} $dep->{version},\n";
...
sub usage {
	 print STDERR "Usage:\tTRefactorAddOn_installer [-a] install\n";
	 print STDERR "\tTRefactorAddOn_installer uninstall\n";
	 print STDERR "Install or uninstall TRefactorAddOn. Default is to install. Should be run\n";
...
my @manifest = ( 	"./bin/trefactor", # 
	"./data/TRefactorAddOn.cfg", # 
	"./data/TWiki/TRefactorAddOn.txt", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/AdminLock.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/build.pl", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/Connection.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/FLock.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/Locks.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/Refactoring.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/Topics.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn/Trace.pm", # 
	"./lib/TWiki/Contrib/TRefactorAddOn.pm", # 
	"./TRefactorAddOn/doc/LICENSE.txt", # 
	"TRefactorAddOn_installer.pl", # Install script
 );
...
if( $install ) {
	 ...
	 unless ( $#dead > 1 ) {
		  die "No part of TRefactorAddOn is installed";
	 }
	 print "To uninstall TRefactorAddOn, the following files will be deleted:\n";
	 print join( ", ", @dead );
	 my $reply;
	 print "\nAre you SURE you want to uninstall TRefactorAddOn? [y/n] ";
	 while ( ( $reply = <STDIN> ) !~ /^[yn]/i ) {
		  print "Please answer yes or no\n";
	 }
	 if( $reply =~ /^y/i ) {
	 ...
	 print "### TRefactorAddOn uninstalled ###\n";
}
