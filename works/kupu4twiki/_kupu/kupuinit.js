...
// $Id: kupuinit.js,v 1.1 2004/09/08 16:10:13 romano Exp $
...
function initKupu(iframe) {
    ...
    */
    ...
    var permstool = new TWikiPermsTool('kupu-perms-selector', 'perm-header', 'view-perms', 'change-perms', 'input-perms', 'list-perms', 'remove-perms', 'perms-close');
    kupu.registerTool('permstool', permstool);

    var linktool = new LinkTool(conf.current_web);
    kupu.registerTool('linktool', linktool);
    var linktoolbox = new LinkToolBox("div-current-web", "div-all-web", "div-external", "linkCurrentWeb", "linkAllWeb", "linkExternal", "current-web-select", "all-web-select", "kupu-link-input", "kupu-link-button", 'kupu-toolbox-links', 'kupu-toolbox-addlink', 'kupu-toolbox', 'kupu-toolbox-active');
    linktool.registerToolBox('linktoolbox', linktoolbox);

    var attachmentstool = new AttachListTool();
    kupu.registerTool('attachmentstool', attachmentstool);
    var attachmenttoolbox = new AttachListToolBox('kupu-attachments-iframe', 'kupu-toolbox', 'kupu-toolbox-active');
    attachmentstool.registerToolBox('attachmenttoolbox', attachmenttoolbox);

    var twikiimagestool = new TWikiImagesTool('kupu-twikiicons-button', 'kupu-twikiicons');
    kupu.registerTool('twikiimage', twikiimagestool);

    var twikivartool = new TWikiVarTool();
    kupu.registerTool('twikivartool', twikivartool);
    var twikivartoolbox = new TWikiVarToolBox("twiki-var-select", "twiki-var-button", 'kupu-toolbox', 'kupu-toolbox-active');
    ...
    var rollingtool = new RollingTool(new Array(
                                      'links-title',
                                      'variables-title',
                                      'attachments-title',
                                      'tables-title',
