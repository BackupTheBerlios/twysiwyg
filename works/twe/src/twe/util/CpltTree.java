 ...
 * @version 1.0
 */
public class CpltTree implements TreeNode, Serializable {

  /** Linked topic */
  public ComplTopic root;
  /** Parent */
  private CpltTree parent;
  /** List of children */
   ...
   * @param parent Tree
   */
  public CpltTree(ComplTopic root, CpltTree parent) {
    this.root = root;
    this.parent = parent;
  }
  ...
  public int getHierarchy() {
    if (this.getParent() != null)
      return ((CpltTree)this.getParent()).getHierarchy() + 1;
    return 0;
  }
   ...
   * @param node Tree
   */
  public void addChild(CpltTree node) {
    children.add(node);
  }
   ...
   * @param node Tree
   */
  public void removeChild(CpltTree node) {
   ...
   * @return Tree
   */
  public CpltTree getNode(String name) {
    int idx = 0;
    ...
    if ((idx = name.indexOf(".")) == -1) {
      ...
      // Retrieve root
      CpltTree tr = getNode(name.substring(0, idx));
