...
public class Topic  implements java.io.Serializable {
    ...
    private fr.unice.twikiservice.Attachment[] attachments;
    ...
    public fr.unice.twikiservice.Attachment[] getAttachments() {
        return attachments;
    }

    public void setAttachments(fr.unice.twikiservice.Attachment[] attachments) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://twikiservice.unice.fr", "Topic"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://twikiservice.unice.fr", "Attachment"));
        typeDesc.addFieldDesc(elemField);
    }
